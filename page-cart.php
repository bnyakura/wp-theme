 ...
 * Cilla Skyn cream theme (see the "Cart page" rules in src/input.css,
 * scoped under .wp-theme-cart-page).
 *
 ...
 * to index.php, which has no top padding for this section.
 *
...
while ( have_posts() ) :
	the_post();
	?>
	<section class="wp-theme-cart-page bg-cream px-4.5 pb-24 pt-16 font-sans-cs text-cs-ink antialiased min-[481px]:px-6 min-[1081px]:px-[5vw]">
