<?php
/**
 * Default Repeater rows for the Contact block, mirrored from the fallback
 * arrays in blocks/contact/render.php so the block editor form isn't blank
...
return array(
	'field_contact_testimonials' => array(
		array(
			'initials' => 'K',
			'name'     => 'Kamva',
