...
$eyebrow  = $eyebrow ?: 'What Members Say';
$title    = $title ?: 'The Brotherhood Speaks';
$subtitle = $subtitle ?: 'Not endorsements — honest accounts from members who showed up and did the work.';

$iga_testimonials_defaults = array(
    array(
        'initials' => 'K',
        'name'     => 'Kamva',
...
if ( empty( $testimonials ) ) {
    $testimonials = $iga_testimonials_defaults;
}
