 ...
 * fell back to index.php, which has no top padding, so the fixed header
 * overlapped the checkout title and the top of the contact/address form.
 *
...
while ( have_posts() ) :
	the_post();
	?>
	<section class="wp-theme-checkout-page bg-ink px-4.5 pb-24 pt-32 font-sans text-off antialiased min-[481px]:px-6 min-[1081px]:px-[5vw]">
